...
//        ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("ru/lionsoft/hello/spring/context/lab01_2/applicationContext.xml");
...
//        Teacher teacher = (Teacher) ctx.getBean("springGuru"); // old style
